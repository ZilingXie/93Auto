<?php 
    ...
    $type = $_GET["type"];
    $CarDisplayQuery = "SELECT * FROM CarDisplay WHERE Type = '$type' ORDER BY V_ID ASC";

    $check = dbquery($CarDisplayQuery);
...
<html lang="en">
	...
	<BODY>
        <header class="Shop">
                ...
                <section class="Vdisplay clearfix" >
                    ...
                    <?php
                       // if($row[7]=='avaliable'){
                        ...
                        for($j=0;$j<3;$j++){
                            ...
                            echo"<div class='col span-1-of-3 box'><a href='CarDisplay.php?vid=$row[0]'><img class='CarImg' height='200px' weight='200px' src='..//resources/CarPic/$type/$row[3]/$row[0].$row[4]/display.jpg'><p class='Vdetail'>$row[2] $row[3] $row[4]</br></p></a></div>";
