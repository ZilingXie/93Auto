    ...
    <body>
        <header>
                <nav>
                    ...
                    <div>
                        <p style="text-align:center; font-size: 150%; font-weight: bold; color:#FFFFFF">Please Search for the Vehicle you want to update.</p>
                    </div>

                    <script>
                function validateForm() {
                    var w = document.forms["myForm"]["year"].value;
                    var x = document.forms["myForm"]["vid"].value;
                    ...
                    <form name="myForm" class="example" action="UpdateSearch.php" method="POST" onsubmit="return validateForm()">
                        <div class="search-box" required>
                          
                            <input class="search" type="number" placeholder="VID" name="vid">
