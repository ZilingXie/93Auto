<?php
    ...
    $query1 = "SELECT * FROM Employee WHERE E_ID = '$eid'";
    $res1 = dbquery($query1);
...
<html lang="en">
        <head>
                ...
                <title>Employe Info Update</title>
            </head>
        ...
        <header>
                <nav>
                    ...
                    <section class="VInfo">
                            ...
                            <div class="row">
                                    <h2><span style="color: #fff">Employee Information Update</span></h2>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col span-2-of-3">
                                        <?php echo"<input type='email' name='email' id='email' placeholder='$row[1]'>" ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col span-2-of-3">
                                        <?php echo"<input type='text' name='eid' id='eid' placeholder='$row[3]'>" ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col span-2-of-3">
                                        <?php echo"<input type='text' name='fname' id='fname' placeholder='$row[4]'>" ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col span-2-of-3">
                                        <?php echo"<input type='number' name='ssn' id='ssn' placeholder='$row[5]'>" ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col span-2-of-3">
                                        <?php echo"<input type='text' name='salary' id='salary' placeholder='$row[6]'>" ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col span-2-of-3">
                                        <?php echo"<input type='hidden' name='eid' id='eid' value='$row[0]'>"?>
