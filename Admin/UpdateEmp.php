    ...
    <body>
        <header>
                <nav>
                    ...
                    <div>
                        <p style="text-align:center; font-size: 150%; font-weight: bold; color:#FFFFFF">Please Search for the Employee you want to update.</p>
                    </div>
                    <script>
                function validateForm() {
                    ...
                    <form name="myForm" class="example" action="UpdateEmpSearch.php" method="POST" onsubmit="return validateForm()">
                        <div class="search-box" require>
                          
                            <input class="search" type="number" placeholder="EID" name="eid">
