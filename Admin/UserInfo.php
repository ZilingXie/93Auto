    ...
    <body>
        <header>
                <nav>
                    ...
                    <div>
                        <p style="text-align:center; font-size: 150%; font-weight: bold; color:#FFFFFF">Please Search for the user you want to see.</p>
                    </div>
                    <script>
                function validateForm() {
                    ...
                    <form name = "myForm" class="example" action="UserInfoSearch.php" method="POST" onsubmit="return validateForm()">
